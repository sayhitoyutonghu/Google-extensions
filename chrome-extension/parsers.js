...
if (typeof LinkedInParser !== 'undefined') {
  console.warn('LinkedInParser already exists, skipping redefinition');
} else {
...
if (typeof IndeedParser !== 'undefined') {
  console.warn('IndeedParser already exists, skipping redefinition');
} else {
class IndeedParser {
  canParse(email){
    const fromEmail = (email.from || '').toLowerCase();
...
if (typeof GenericParser !== 'undefined') {
  console.warn('GenericParser already exists, skipping redefinition');
} else {
class GenericParser {
  canParse(email){
    const fromEmail = (email.from || '').toLowerCase();
...
if (!window.parsers) {
  window.parsers = [new LinkedInParser(), new IndeedParser(), new GenericParser()];
}
